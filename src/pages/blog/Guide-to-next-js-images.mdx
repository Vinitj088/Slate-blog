...
tags: ['next js', 'guide']
category: Guides
imageUrl: /images/nxjs.webp
authorURL: /images/pp.webp
Excerpt: In this article we introduce adding images in the tailwind starter blog and the benefits and limitations of the next/image component.
---

import BlogPostLayout from '@/components/BlogPostLayout';
import BlogPostImage from '../../../public/images/nxjs.webp';

export default ({ title, publishedAt, children }) => <BlogPostLayout
    title="Images in Next.js: Adding Images in the Tailwind Starter Blog"
    ...
    publishedAt="10/15/2023"
    keywords="images, nextjs, tailwindcss, next-themes"
