---
title: 'Markdown Guide Based on Github Flavored Markdown'
publishedAt: 10/17/2023
tags: ['github', 'guide']
category: Guides
imageUrl: /images/mdx.webp
...
import BlogPostImage from '../../../public/images/mdx.webp';

export default ({ title, publishedAt, children }) => <BlogPostLayout
    title="Markdown Guide : Guide Based on Github Flavored Markdown"
    ...
    publishedAt="10/17/2023"
    keywords="markdowx, text, nextjs, tailwindcss, next-themes"
